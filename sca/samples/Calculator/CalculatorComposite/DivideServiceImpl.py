...
#   <implementation.python module="DivideServiceImpl" class="DivideClass"/>
# 
# Or just use the module-level divide function
# e.g. in CalculatorComposite.composite use the line:
#   <implementation.python module="DivideServiceImpl" />
# 
...
class DivideClass:
    ...
    def __init__(self):
        print "Python - DivideServiceImpl.DivideClass constructor"

    # The class-level divide function
    def divide(self, val1, val2):
        result = float(val1) / float(val2)
        print "Python - DivideServiceImpl.DivideClass.divide " + str( val1 ) + " / " + str(val2) + " = " + str(result)
        return result

# The module-level divide function
def divide(val1, val2):
    result = float(val1) / float(val2)
    print "Python - DivideServiceImpl.divide " + str(val1) + " / " + str(val2) + " = " + str(result)
    return result
