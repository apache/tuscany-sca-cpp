...
copy %currentPath%\Client\%buildMode%\calculator_client.exe %destinationPath%\bin
if %buildMode% == Debug (
copy %currentPath%\Client\%buildMode%\calculator_client.pdb %destinationPath%\bin
)
