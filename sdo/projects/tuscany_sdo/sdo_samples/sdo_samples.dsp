...
# ADD CPP /nologo /W3 /GX /O2 /I "..\..\..\deploy\include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /FD /c
...
SOURCE="$(InputPath)"
PostBuild_Cmds=copy ..\..\..\runtime\core\samples\*.xsd ..\..\..\runtime\core\samples\Release	copy ..\..\..\runtime\core\samples\*.xml ..\..\..\runtime\core\samples\Release	copy ..\..\..\runtime\core\samples\*.wsdl ..\..\..\runtime\core\samples\Release	copy ..\..\..\deploy\bin\*.dll ..\..\..\runtime\core\samples\Release
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\..\deploy\include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FD /GZ /c
...
# ADD LINK32 tuscany_sdo.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /out:"Debug/samples.exe" /pdbtype:sept /libpath:"..\..\..\deploy\lib"
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy ..\..\..\runtime\core\samples\*.xsd ..\..\..\runtime\core\samples\Debug	copy ..\..\..\runtime\core\samples\*.xml ..\..\..\runtime\core\samples\Debug	copy ..\..\..\deploy\bin\*.dll ..\..\..\runtime\core\samples\Debug	copy ..\..\..\deploy\bin\*.pdb ..\..\..\runtime\core\samples\Debug	copy ..\..\..\runtime\core\samples\*.wsdl ..\..\..\runtime\core\samples\Debug
# End Special Build Tool
