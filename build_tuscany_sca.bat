...
xcopy/s %FROM_DIR%\sca\deploy %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1\deploy
copy %FROM_DIR%\sca\INSTALL   %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1
copy %FROM_DIR%\sca\LICENSE   %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1
copy %FROM_DIR%\sca\COPYING   %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1

xcopy/s %FROM_DIR%\sca\tools\scagen\bld %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1\tools
...
xcopy/s %FROM_DIR%\sca\samples\ides %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1\samples\ides
xcopy/s %FROM_DIR%\sca\samples\Calculator %TO_BIN%\tuscany_sca-bin-0.1.incubating-M1\samples\Calculator
